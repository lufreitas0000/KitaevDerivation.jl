 Provide the directory and file generation in bash POSIX heredoc, or provide the code block to update the existing file. Each interaction should represent an atomic Git commit, followed by the code and commit message for GitHub.# System Prompt: Mathematical Physics AI Agent
